...
!
    function(t, e) {
        ...
        function() {
            ...
            function y(t, e) {
                var n, o;
                if (Y(t)) for (n = 0; n < t.length; n++) e.call(t[n], t[n], n);
                else if (f(t)) for (o in t) G.call(t, o) && e.call(t[o], t[o], o);
                return t
            }
            function v(t) {
            ...
            var ot = function(t) {
                ...
                ut = function(t, e) {
                    d(t.body) ? t.headers.delete("Content-Type") : (f(t.body) || Y(t.body)) && (t.emulateJSON ? (t.body = $.params(t.body), t.headers.set("Content-Type", "application/x-www-form-urlencoded")) : t.body = JSON.stringify(t.body)),
                        e(function(t) {
                ...
                pt = function(t, e) {
                    y(Z({},
                        L.headers.common, t.crossOrigin ? {}: L.headers.custom, L.headers[u(t.method)]),
                        function(e, n) {
                ...
                lt = function(t) {
                    function o(o) {
                        return new e(function(e) {
                                function s() {
                                    r = i.pop(),
                                        c(r) ? r.call(t, o, a) : (n("Invalid interceptor of type " + typeof r + ", must be a function"), a())
                                }
                                function a(n) {
                                    if (c(n)) u.unshift(n);
            ...
            var yt = function(t, e) {
                ...
                this.url = n,
                    ...
                    this.body = t,
                    a(t) ? this.bodyText = t: h(t) && (this.bodyBlob = t, H(t) && (this.bodyText = q(t)))
            };
